...
public class Audience {
    ...
    private Map<String, Function> createOperatorsMap() {
        ...
        operatorsMap.put("contains", (object, params) -> {
        ...
        operatorsMap.put("not_contains", (object, params) -> {
            String storedValue = ((Map<String, String>) object).get(
                    ((JsonArray) params).get(0).getAsString());
            if (storedValue == null) {
                return false;
        ...
        operatorsMap.put("equal", (object, params) -> {
            String storedValue = ((Map<String, String>) object).get(
                    ((JsonArray) params).get(0).getAsString());
            if (storedValue == null) {
                return false;
        ...
        operatorsMap.put("not_equal", (object, params) -> {
            String storedValue = ((Map<String, String>) object).get(
                    ((JsonArray) params).get(0).getAsString());
            if (storedValue == null) {
                return false;
    ...
    public boolean filter(Map<String, String> userAttributes, JsonObject allocation) {
        ...
        if (userAttributes == null || userAttributes.isEmpty()
                ...
                || ((JsonObject) audienceQuery).size() == 0
        ) {
            return false;
        }
